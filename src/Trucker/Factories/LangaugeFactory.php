...
class LanguageFactory extends FactoryDriver
{
    /**
    ...
    {
        return "\Trucker\Requests\Langauge";
    }
    ...
    {
        return "\Trucker\Requests\Langauge\LanguageInterface";
    }
    ...
    {
        return Config::get('request.language');
    }
}
